...
return [
    ...
    'rgbd' => [
        ...
        'content' => '
            <div>
                <p> The SPORTClub attaches great importance to the protection of your personal data. </p>
            
                <p> By registering on the SPORTClub portal of the Faculty of Pharmacy of SPORTClub(hereinafter "SPORTClub"),
                ...
                <p> SPORTClub staff members who have access to your data are bound by an obligation of confidentiality, which implies in particular: </p>
                ...
                <p> All your questions about the protection of your data by ULB can be sent to the Data Protection Officer: rgpd@SPORTClub.ac.be. </p>
