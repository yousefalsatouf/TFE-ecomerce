        ...
        <section class="quick-access">
            <div class="articles container">
                <div class="col-lg-4">
                    ...
                    <div>
                        <a href=""><b class="fa fa-toggle-right btn btn-outline-dark"></b></a>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div>
                    ...
                    <div>
                        <a href="{{url('/contact')}}"><b class="fa fa-toggle-right  btn btn-outline-dark"></b></a>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div>
                    ...
                    <div>
                        <a href="{{url('/about')}}"><b class="fa fa-toggle-right btn btn-outline-dark"></b></a>
                    </div>
                </div>
            </div>
        </section>
