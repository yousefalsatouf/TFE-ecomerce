    ...
    <section id="cart_items infos">
        <div class="container">
            <div class="breadcrumbs">
                <ol class="breadcrumb">
                    <li><b class="text-success">Bonjour {{ucwords(Auth::user()->name)}},</b></li>
                    <li><b class="text-info">Gérez vos infos</b></li>
                </ol>
            </div>
            @if(session('msg'))
                    ...
                    <div class="container">
                        ...
                        @foreach($users as $user)
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="first-name" class="form-label font-weight-bolder">First Name</label>
                                    <input id="first-name" type="text" name="first_name" value="{{ isset($user->first_name)?$user->first_name:'' }}" class="form-control">
                                    <br>
                                    <span style="color:red">{{ $errors->first('first_name') }}</span>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="last-name" class="form-label font-weight-bolder">Last Name</label>
                                ...
                                <div class="form-group col-md-6">
                                    <label for="street" class="form-label font-weight-bolder">Street</label>
                                ...
                                <div class="form-group col-md-6">
                                    <label for="street-number" class="form-label font-weight-bolder">Street Number</label>
